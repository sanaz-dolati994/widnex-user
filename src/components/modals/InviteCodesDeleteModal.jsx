...
const InviteCodesDeleteModal = ({ onModalBtnClicked }) => {
	return (
		<div style={{ width: '100%' }}>
			<MText>
				<Text tid='delete-invite-code' />
			</MText>
			<BtnContainer>
				<Btn onClick={() => onModalBtnClicked(1)} bgColor='#1ce087'>
					<Text tid='submit' />
				</Btn>
				<Btn onClick={() => onModalBtnClicked(2)} bgColor='#a12356'>
					<Text tid='cancel' />
				</Btn>
			</BtnContainer>
		</div>
...
export default InviteCodesDeleteModal
